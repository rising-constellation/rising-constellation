defmodule Portal.ScenariosLive do
  ...
  def mount(_params, _session, socket) do
    {:ok, assign(socket, %{filters: Scenarios.Scenario, show_filters: false})}
  end
  ...
  @impl true
  def handle_event("filter", %{"Elixir.RC.Scenarios.Scenario" => filters} = params, socket) do
  ...
  defp get_and_assign_page(params) do
    ...
    } = Scenarios.list_scenarios(params)
