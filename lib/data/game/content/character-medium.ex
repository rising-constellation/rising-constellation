defmodule Data.Game.Character.Content.Medium do
  def data do
    [
      %Data.Game.Character{
        key: :admiral,
        ...
        credit_cost_range: 150..375,
        technology_cost_range: 50..88,
      ...
      %Data.Game.Character{
        ...
        credit_cost_range: 300..525,
        technology_cost_range: 0..0,
        ideology_cost_range: 25..63
      },
      %Data.Game.Character{
        key: :speaker,
        initial_protection: 0,
        ...
        technology_cost_range: 25..63,
        ideology_cost_range: 50..88
      }
    ]
  end
end
