...
defmodule Data.Game.Doctrine.Content.Medium do
  def data do
    [
      %Data.Game.Doctrine{
        ancestor: nil,
      ...
      %Data.Game.Doctrine{
        ...
        bonus: [
          %Core.Bonus{from: :direct, to: :spy_cover, type: :add, value: 0.5},
      ...
      %Data.Game.Doctrine{
        ancestor: :agent,
        bonus: [
          %Core.Bonus{from: :direct, to: :player_ideology, type: :add, value: 4},
          %Core.Bonus{from: :direct, to: :player_technology, type: :add, value: 4}
        ],
        class: :speaker,
        cost: 50,
      ...
      %Data.Game.Doctrine{
        ancestor: :speaker_1,
        bonus: [%Core.Bonus{from: :direct, to: :player_ideology, type: :add, value: 8}],
        class: :speaker,
        cost: 175,
      ...
      %Data.Game.Doctrine{
        ancestor: :ideo_1,
        bonus: [%Core.Bonus{from: :direct, to: :player_ideology, type: :add, value: 20}],
        class: :speaker,
        cost: 400,
      ...
      %Data.Game.Doctrine{
        ancestor: :speaker_1,
        bonus: [%Core.Bonus{from: :direct, to: :player_technology, type: :add, value: 8}],
        class: :speaker,
        cost: 200,
      ...
      %Data.Game.Doctrine{
        ancestor: :tech_1,
        bonus: [
          %Core.Bonus{from: :direct, to: :player_technology, type: :add, value: 14},
          %Core.Bonus{from: :direct, to: :player_speaker, type: :add, value: 2}
        ],
        class: :speaker,
        cost: 375,
      ...
      %Data.Game.Doctrine{
        ancestor: :tech_2,
        bonus: [%Core.Bonus{from: :direct, to: :sys_happiness, type: :add, value: 30}],
        class: :speaker,
        cost: 600,
